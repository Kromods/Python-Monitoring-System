...
def send_email_alert(subject, body):
    sender_mail = "marten.rosinski@mcs.de" # Absender adresse hier würde ich meine Firmen Mail nehmen
    receiver_mail = "rosinskimarten@gmail.com" # Receiver Mail ( maybe hier die Privatadressen)
    password = "3malschwarzerKater!" # Hier muss das Passwort der Absender Adresse rein (maybe App specific Passwort)
...
try:
    ...
    server.sendmail(sender_mail, receivermail, text) # EMail senden
